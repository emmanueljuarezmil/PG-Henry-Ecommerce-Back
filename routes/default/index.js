...
const {getProducts, getProductsById, addProduct, updateProduct, deleteProduct, fullDbproducts, getProductsForSearchBar} = require('../../control/default/products.js')
const {checkJwt, isAdmin, isAuth} = require('../../control/auth/index.js')

const router = Router();
  
router.get('/products', getProducts);
router.get('/productsforsearchbar', getProductsForSearchBar);
